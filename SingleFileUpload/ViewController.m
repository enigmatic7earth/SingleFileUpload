...
-(NSString *) getUniqueFileNameFor:(NSString *)filename{
    ...
    NSString *str11 = [str stringByReplacingOccurrencesOfString:@"-" withString:@""];
    NSString *str12 = [str11 stringByReplacingOccurrencesOfString:@":" withString:@""];
